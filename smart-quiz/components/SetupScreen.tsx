...
const SetupScreen: React.FC<SetupScreenProps> = ({ onComplete, lang }) => {
  ...
  return (
    <div className="min-h-screen bg-white p-6 pb-32 flex flex-col max-w-md mx-auto">
      <div className="mt-8 mb-10">
        <h1 className="text-3xl font-black text-gray-900 mb-2">আপনার প্রোফাইল <br/>তৈরি করুন</h1>
        <p className="text-gray-500 font-medium">সঠিক কন্টেন্ট পেতে আপনার তথ্যগুলো দিন</p>
      </div>
